...
import { Loader2, Plus, Edit, Eye, Trash2, FileText, Clock, ArrowLeft, Home } from 'lucide-react';
...
const Dashboard = () => {
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description: t('dashboard.errorLoadResumes'),
          variant: "destructive"
        });
        return;
      }
  ...
  const deleteResume = async (id: string) => {
    try {
      ...
      toast({
        ...
        description: t('dashboard.resumeDeleted')
      });
  ...
  const togglePublic = async (id: string, currentPublicStatus: boolean) => {
    try {
      ...
      toast({
        title: t('common.success'),
        description: `${t('dashboard.resumeNow')} ${!currentPublicStatus ? t('dashboard.public') : t('dashboard.private')}`
      });
  ...
  const getResumeTitle = (resumeData: any) => {
    ...
    return t('dashboard.untitledResume');
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <h1 className="text-3xl font-bold">{t('dashboard.yourResumes')}</h1>
